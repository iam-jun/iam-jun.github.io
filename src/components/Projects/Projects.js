      ...
      <Container>
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={bicGroup}
              title="BIC Group | A Plaform for all communities"
              description="During my three-year tenure as a Mobile Developer at Beincom, I had the privilege of being a part of the core team responsible for building the app from the scratch."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={bicChat}
              title="BIC Chat"
              description="Both, the BIC Chat app and the Beincom platform allows everyone to conveniently and safely interconnect with one another."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="At Futurity, I also had the opportunity to work as a part of a team that developed EveHR and created customized versions for other prominent companies, including AIA, DHL, Suntory, Nestle..."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="Another project that I also worked on was to develop a native android app that upload files to a physical storage that works as  a cloud storage"
